...
def record_pipeline_run(
    ...
    entry = {
        ...
        "tool2_duration": round(stage_metrics.get("Tool 2: delimiter_detector", {}).get("duration_sec", 0), 3),
        "tool2_elapsed": round(elapsed_times.get("Tool 2: delimiter_detector", 0), 3),
        ...
        "tool6_duration": round(stage_metrics.get("Tool 6: load_to_bigquery", {}).get("duration_sec", 0), 3),
        "tool6_elapsed": round(elapsed_times.get("Tool 6: load_to_bigquery", 0), 3),
